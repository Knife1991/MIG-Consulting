        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-8 mx-auto">
                <div class="feature p-5 d-flex flex-column justify-content-between shadow rounded">
                    ...
                    <p class="text-center">Miglioramento dei processi aziendali, ottimizzazione delle operazioni e
                        implementazione di nuove tecnologie.</p>
                    <p><a class="btn btn-mig d-block mx-auto text-white"
                            href="{{ route('consulenza-aziendale') }}">Scopri di piú</a></p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="d-block mx-auto accordion accordion-flush" id="accordionFlushExample">
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseThree" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body fs-5">La nostra priorità è il successo dei nostri clienti.
                                Lavoriamo a stretto contatto con te, ascoltando le tue esigenze e fornendo supporto
                                continuo per assicurarti di raggiungere i tuoi obiettivi aziendali.</div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                        ...
                        <div id="flush-collapseOne" class="accordion-collapse collapse"
                            data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body fs-5">Ogni azienda è unica, e lo sono anche le sue esigenze.
                                Offriamo soluzioni su misura che si adattano perfettamente agli obiettivi e alle sfide
                                specifiche del tuo business, assicurandoci che ogni passo verso il successo sia
                                strategicamente pianificato e implementato.</div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                        ...
                        <div id="flush-collapseTwo" class="accordion-collapse collapse"
                            data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body fs-5">Non ci limitiamo a consulenze teoriche. Il nostro approccio
                                pratico e orientato ai risultati ha portato a un aumento delle performance aziendali e a
                                una crescita significativa per i nostri clienti.</div>
                        </div>
                    </div>
                </div>
            </div>
